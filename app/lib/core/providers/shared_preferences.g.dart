...
const sharedPreferencesInternalProvider = SharedPreferencesInternalProvider._();

final class SharedPreferencesInternalProvider
    extends
        $FunctionalProvider<
  ...
  const SharedPreferencesInternalProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
  ...
  @override
  String debugGetCreateSourceHash() => _$sharedPreferencesInternalHash();
  ...
  FutureOr<SharedPreferences> create(Ref ref) {
    return sharedPreferencesInternal(ref);
  }
}
